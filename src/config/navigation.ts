...
export const adminNavigation: AdminNavItem[] = [
  ...
  ...(isValuationsEnabledForV1()
    ? [{ href: "/admin/valorizaciones", label: "Valorizaciones", icon: ClipboardList, status: "active" as const }]
    : []),
  ...
  { href: "/admin/auditoria", label: "Auditoría", icon: ScrollText, status: "active" },
];
